...
import { Briefcase, Users, Plus, TrendingUp, CheckCircle, XCircle, Star, FileText, ArrowRight, Building2 } from "lucide-react";
            ...
            {isLoading ? (
              ...
              <div className="divide-y">
                {data.recentApplications.map((app) => {
                  ...
                  return (
                    <div key={app.id} className="py-3 flex items-center justify-between gap-4" data-testid={`app-row-${app.id}`}>
                      <div className="min-w-0 flex-1">
                        <div className="font-medium text-sm">{app.candidate?.user?.name}</div>
